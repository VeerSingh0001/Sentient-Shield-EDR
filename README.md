...
### Week 2: File Integrity Monitoring (FIM) & Detection Engineering ⏳
- [ ] Configure FIM to watch sensitive application directories.
- [ ] Write custom XML Detection Rules for proprietary log formats.
